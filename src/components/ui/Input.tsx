      ...
      <div className={cn('flex flex-col gap-1.5 w-full', containerClassName)}>
        ...
        <div className="relative flex items-center w-full">
          ...
          <input
            ...
            disabled={disabled}
            className={cn(
              'w-full bg-slate-900/90 text-slate-100 placeholder:text-slate-500 text-sm rounded-xl border px-3.5 py-2.5 outline-none transition-all duration-200',
              'border-slate-800 focus:border-emerald-500/80 focus:ring-2 focus:ring-emerald-500/20',
              leftIcon && 'pl-10',
              (rightIcon || isPasswordType) && 'pr-10',
              error && 'border-rose-500 focus:border-rose-500 focus:ring-rose-500/20 text-rose-100',
          ...
          {isPasswordType ? (
            <button
              ...
              className="absolute right-3.5 text-slate-400 hover:text-slate-200 transition-colors p-1 rounded-lg focus:outline-none"
