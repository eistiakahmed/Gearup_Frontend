...
function PaymentSuccessContent() {
  ...
  return (
    <div className="w-full max-w-xl z-10">
      <Card className="p-6 sm:p-8 text-center bg-white border-slate-200 shadow-xl">
        <CardContent className="flex flex-col items-center gap-6 p-0">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm mt-2 leading-relaxed">
              Your rental payment was processed successfully via Stripe. Your order status is now updated to <strong className="text-emerald-700 font-semibold">PAID</strong>.
            </p>
          </div>

          {/* Status Notice */}
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 w-full text-left text-xs sm:text-sm flex flex-col gap-2">
...
export default function PaymentSuccessPage() {
  return (
    <PublicLayout>
      <div className="min-h-screen bg-slate-50 text-slate-900 flex items-center justify-center p-4 sm:p-6 lg:p-10 relative overflow-hidden">
        ...
        <Suspense fallback={<Loader2 className="w-10 h-10 animate-spin text-emerald-600" />}>
