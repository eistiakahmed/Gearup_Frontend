        ...
        <div className="lg:col-span-5 flex flex-col gap-8 pr-0 lg:pr-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-start gap-3.5 p-3.5 rounded-xl bg-white border border-slate-200 shadow-sm">
              ...
              <div>
                <h4 className="text-sm font-semibold text-slate-900">Instant Booking & Payments</h4>
                <p className="text-xs text-slate-600">Select rental dates with ease and pay securely via Stripe.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5 p-3.5 rounded-xl bg-white border border-slate-200 shadow-sm">
              ...
              <div>
                <h4 className="text-sm font-semibold text-slate-900">Verified Providers & Equipment</h4>
                <p className="text-xs text-slate-600">Every gear listing undergoes platform inspection for quality.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5 p-3.5 rounded-xl bg-white border border-slate-200 shadow-sm">
              ...
              <div>
                <h4 className="text-sm font-semibold text-slate-900">Multi-Role Platform</h4>
                <p className="text-xs text-slate-600">Tailored dashboards for Customers, Providers, and Admins.</p>
              </div>
            </div>
          </div>
        </div>
